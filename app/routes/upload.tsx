...
const Upload = () => {
    ...
    const handleAnalyze = async({companyName, jobTitle, jobDescription, file}: {companyName: string, jobTitle: string, jobDescription: string, file: File}) => {
        ...
        if (!uploadedFile) return setStatusText('Error in uploading the file');
        ...
        if (!uploadedImage) return setStatusText('Error in uploading the image');

        setStatusText('Prepping the data...');
        ...
        if (!feedback) return setStatusText('Error in analyzing the resume');
                        ...
                        !isProcessing && (
                            <form id="upload-form" onSubmit={handleSubmit} className="flex flex-col gap-4 mt-8">
                                ...
                                <div className="form-div">
                                    ...
                                    <textarea rows={5} id="job-desxription" name="job-description" placeholder="Job Description"></textarea>
                                </div>
                                <div className="form-div">
